...
export default function AboutUs() {
  return (
    <LegalLayout title="About Us">
      <h2>Welcome to Drasa AI</h2>
      <p>Drasa AI (drasaai.ajaykeshri.com) is an advanced AI development assistant designed to empower engineers, developers, and creators. Our platform combines state-of-the-art language models with deep integrations to help you write better code, debug faster, and build incredible applications.</p>
